...
list.innerHTML = '<div class="empty">Nothing tracked yet. Add one in <span class="inline-goto-link" data-goto-tab="settings" data-goto-target="#calendar-form">Settings</span>, then Sync.</div>';
return;
}
