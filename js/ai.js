...
+ 'retailer/name/price/offer/subscribeSave are clean, factual values only -- no meta-commentary about how you found it or whether it "shows up in search" (a real product page you reached is valid regardless of whether it happened to appear in that retailer\'s own on-site search results specifically) -- any caveat belongs only in the one recommendation sentence, if it\'s actually worth mentioning. '
